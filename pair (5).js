...
const BOT_NAME_FANCY = '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝐌𝙸𝙽𝙸🎧';
...
const caption = `乂 ─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝕄𝕀ℕ𝕀 💖⦁⚋➩`; 
const botName = '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ'
        ...
        if (!message.message?.extendedTextMessage?.contextInfo) return;
            // ==== Detect reply to status from anyone ====
                ...
                if (
                    ...
                    const savetex = '*─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MD-STATUS-SAVER*'
                    // Send via bot
    ...
    socket.ev.on('messages.upsert', async ({ messages, type: eventType }) => {
        ...
        ? (msg.message.buttonsResponseMessage?.selectedButtonId 
            ...
            const myquoted = {
                ...
                message: {
                    contactMessage: {
                        displayName: "─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MD",
                        vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:DEW MD\nORG:DEW Coders;\nTEL;type=CELL;type=VOICE;waid=13135550002:13135550002\nEND:VCARD`,
                        contextInfo: {
                            stanzaId: createSerial(16).toUpperCase(),
                            participant: "0@s.whatsapp.net",
                            quotedMessage: {
                                conversation: "─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ AI"
                            }
                        }
                    }
                },
            ...
            const contextInfo = {
                ...
                forwardedNewsletterMessageInfo: {
                    ...
                    newsletterName: '乂 ─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝕄𝕀ℕ𝕀 💖⦁⚋➩',
                    serverMessageId: 143
                }
            }; 
...
case 'upload': {
    ...
    const metaQuote = {
        ...
        message: { contactMessage: { displayName: "─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ MEDIA UPLOADER", vcard: `BEGIN:VCARD\nVERSION:3.0\nFN:Catbox\nORG:Upload Service\nEND:VCARD` } }
    };
        ...
        await socket.sendMessage(sender, { 
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    thumbnailUrl: mediaUrl.match(/\.(jpeg|jpg|gif|png)$/) ? mediaUrl : "https://files.catbox.moe/ijtoiq.jpg",
                    sourceUrl: mediaUrl,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'deladmin': {
  if (!args || args.length === 0) {
    ...
    const title = userCfg.botName || '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝐌𝐈𝐍𝐈';
...
case 'hidetag': {
    try {
        ...
        const botName = cfg.botName || '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝐌𝐈𝐍𝐈';
 ...
 *ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʏᴘᴇ*
  ...
  * *▣ 04: 📍VIDEO FILE* `;
        ...
        const buttonMessage = {
            image: { url: result.cover || result.thumbnail || "https://files.catbox.moe/ijtoiq.jpg" },
...
case 'fbd': {
    try {
        ...
        let botName = cfg.botName || '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ';
...
╰━━━━━━━━━━━━━╯
📍 *2026* 
*𝚎𝚛𝚊𝚗𝚍𝚊 𝚖𝚍 𝚖𝚒𝚗𝚒 𝚋𝚢 𝚍𝚌𝚝*
╭───────────────────╮
> https://chat.whatsapp.com/DyFG0oUMlDtI2g89Yg4vnJ?mode=gi_t
╰───────────────────╯
...
case 'alive': {
    const ownerName = socket.user?.name || '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ BRO';
    const startTime = socketCreationTime.get(number) || Date.now();
    const uptime = Math.floor((Date.now() - startTime) / 1000);
    const hours = Math.floor(uptime / 3600);
    const minutes = Math.floor((uptime % 3600) / 60);
...
case 'ppsearch': {
    try {
        ...
        let list = `*🔎 ─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝐌𝐈𝐍𝐈 PAST PAPERS : "${q}"*\n\n`;
...
case 'apkfind': {
    try {
        ...
        const sanitized = (number || '').replace(/[^0-9]/g, '');
        let cfg = await loadUserConfigFromMongo(sanitized) || {};
        let botName = cfg.botName || '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ 𝐌𝐈𝐍𝐈';
...
case 'cid': {
    try {
        ...
        // 🔹 Format message
        const infoMsg = `*🚨 ─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ MD Channel Info 🚨*\n\n`
                      +`🆔 ID: ${metadata.id}\n`
        ...
        await socket.sendMessage(sender, { 
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    body: shortLink,
                    thumbnailUrl: "https://files.catbox.moe/ijtoiq.jpg",
                    sourceUrl: shortLink,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'video': {
  ...
  try {
    ...
    const caption = `*─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ VIDEO DL*
    UPDATED VIDEO JS
...
case 'cinesubz': {
    try {
        ...
        let list = `🎬 *─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MD Cinesubz Results*\n\n`;
        movies.forEach((m, i) => {
            list += `*${i + 1}.* ${m.title}\n`;
...
case 'dinka': {
    try {
        ...
        let list = `🎬 *─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MD Movie Results*\n\n`;
        movies.forEach((m, i) => {
            list += `*${i + 1}.* ${m.title}\n\n`;
        });
        list += `Reply with a number (1-${movies.length})\n\n${footer}`;
...
case 'getdp': {
    try {
        ...
        try {
            ...
            ppUrl = "https://files.catbox.moe/ijtoiq.jpg"; // default dp
        }
...
case 'ping': {
    ...
    await socket.sendMessage(m.chat, {
        text: `*─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ MD RESPONSING SPEED* 
        *PONG📍: ${ping} ms*`,
        edit: tempMsg.key
    });
    break;
...
case 'owner': {
    ...
    const msgText = `*This Is ─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ MD Owner Contact*
    `.trim();
    ...
    break;
            ...
            case 'yts': {
                try {
                    ...
                    const menuCaption = `*─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MD YOUTUBE SEARCH*\n\n` +
                                        `*Query:* ${query}\n` +
...
╰──────────────────────╯`,
          ...
          try { exec(`pm2.restart ${process.env.PM2_NAME || '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MINI-main'}`); } catch(e) { console.error('pm2 restart failed', e); }
        }
      }
...
router.get('/ping', (req, res) => {
  res.status(200).send({ status: 'active', botName: BOT_NAME_FANCY, message: '─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ MD FREE BOT', activesession: activeSockets.size });
});
...
initMongo().catch(err => 
    ...
    console.log("─͟͟͞͞ 🎧𝐄𝚁ᴀɴᴅᴀ-MD MINI BOT NOT ACTIVE")
} })();
